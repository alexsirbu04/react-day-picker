...
var DayPicker = exports.DayPicker = function (_Component) {
  ...
  function DayPicker(props) {
    ...
    _this.handleButtonClick = function (e) {
      var today = new Date();
      e.target.blur();
      if (_this.props.onButtonClick) {
        e.persist();
        _this.props.onButtonClick(new Date(today.getFullYear(), today.getMonth(), today.getDate()), ModifiersUtils.getModifiersForDay(today, _this.props.modifiers), e);
      }
    };
